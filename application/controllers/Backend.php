                    ...
                    if(!empty($findPlan) || !empty($findProduct)) {
                        ...
                        if(!empty($findPlan)) {
                            if( $transactionDetails[0]['payment_type'] == 'vendor_plan' ) {
                                ...
                                $outputStr .= '<p> Commission Admin will get : <b>'.$this->ts_functions->getsettings('portal','curreny').' '.$findPlan[0]['vplan_amount'].'</b></p>';
                            }
                            else {
                                ...
                                $outputStr .= '<p> Commission Admin will get : <b>'.$this->ts_functions->getsettings('portal','curreny').' '.$findPlan[0]['plan_amount'].'</b></p>';
                            }
                        ...
                        if(!empty($findProduct)) {
                            ...
                            $outputStr .= '<p> Product Amount : <b>'.$this->ts_functions->getsettings('portal','curreny').' '.$findProduct[0]['prod_price'].'</b></p>';
							 if( isset($adminCommArr[$pId]) ) {
							    $outputStr .= '<p> Commission Admin will get : <b>'.$this->ts_functions->getsettings('portal','curreny').' '.$adminCommArr[$pId].'</b></p>';
							 }
							 if( isset($venCommArr[$pId]) ) {
							    $outputStr .= '<p> Commission Vendor will get : <b>'.$this->ts_functions->getsettings('portal','curreny').' '.$venCommArr[$pId].'</b></p>';
							 }
